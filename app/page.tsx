        ...
        <div className="max-w-[700px]">
          <section className="mb-12">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Full-stack dev | Product person | Digital marketer
            </p>
            <div className="flex space-x-4 mb-8">
              <Button variant="outline" size="icon">
                <Github className="!h-4 !w-4 hover:fill-muted-foreground" />
              </Button>
              <Button variant="outline" size="icon">
                <LinkedIn className="!h-4 !w-4 hover:fill-muted-foreground" />
              </Button>
              <Button variant="outline" size="icon">
                <X className="!h-4 !w-4 hover:fill-muted-foreground" />
              </Button>
            </div>
            <Image
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-4">
              I'm a full-stack developer with a unique blend of digital
              marketing and project management experience. My mission is to
              connect with curious minds and build innovative solutions that
              make a difference. With a passion for technology and a knack for
              problem-solving, I'm always excited to take on new challenges and
            ...
            <p className="text-muted-foreground mb-4">
              ...
              , where we're revolutionizing the 3D LIDAR tools industry on the
              web. It's an exciting journey that combines cutting-edge
              technology with practical applications, and I'm thrilled to be at
