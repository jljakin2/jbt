...
Essentially, emojis are made of [multiple code points](https://pro.arcgis.com/en/pro-app/latest/help/data/geodatabases/overview/a-quick-tour-of-unicode.htm#:~:text=Code points are the numbers,four numbers and%2For letters.), and <Code>length</Code> only counts code points, not characters.
